...
public class FilePhoneBook implements PhoneBook {
	private static final String FILE_PATH = "C:\\Users\\junhong\\eclipse-workspace\\DGSW-JavaStudy\\DGSW_2\\src\\kr\\hs\\dgsw\\java\\c2\\programming_test\\";
	public static final String FILE_NAME = "phoneBook.dat";
	  ...
	  public NameCard getCard(int id) {
	    ...
	    System.out.println("찾는 카드id는 존재하지 않습니다.");
	    return null;
	  }
