...
public class FileStudy {
	public static void main(String[] args) {
		...
		try {
			File renamed = new File("C:/2021_DGSW/DGSW_2/hello");
			
			File file = new File("C:/2021_DGSW/DGSW_2/abc.txt");
			boolean exist = file.exists();
			System.out.println("exist: " + exist);
			
			file = new File("C:/2021_DGSW/DGSW_2/가나다.txt");
			boolean result = file.createNewFile();
			System.out.println("createNewFile: " + result);
			
			file.delete();
			
			File dir = new File("C:/2021_DGSW/DGSW_2/sub");
			result = dir.mkdir();
			System.out.println("mkdir: " + result);
			
			dir.delete();
			
			File hello = new File("C:/2021_DGSW/DGSW_/hello");
			...
			dir = new File("C:/2021_DGSW/DGSW_2");
			File[] list = dir.listFiles();
			for (File file1 : list) {
				System.out.println(file1.getName());
			}
			
			File renamed1 = new File("C:/2021_DGSW/DGSW_2/반갑습니다");
			hello.renameTo(renamed1);
